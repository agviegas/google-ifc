...
var directionalLight = new DirectionalLight(lightColor, 1);
...
var ifcLoader = new IFCLoader(); //wasm

var wasmUrl = document.body.getAttribute('wasmURL');
document.body.removeAttribute('wasmURL');
var wasmDir = wasmUrl.replace("web-ifc.wasm", "");
ifcLoader.setWasmPath(wasmDir); //ifc

var ifcContent = document.body.getAttribute('ifc');
